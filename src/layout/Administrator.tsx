    ...
    return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4">
            ...
            <table className="w-full table-auto text-sm text-left">
                ...
                <tfoot>
                <tr className="border-t bg-[#D9F2D0]">
                    <td colSpan="2" className="px-2 py-1 font-bold text-right">Total</td>
                    <td className="px-2 py-1">{totalPercent}%</td>
                    <td className="px-2 py-1">{totalVotes}</td>
                </tr>
                </tfoot>
            </table>
            </div>
